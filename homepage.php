            ...
            <div class="col-lg-12">
              <nav class="navbar navbar-expand-lg">
                ...
                <div class="navbar-btn d-none d-sm-inline-block">
                  ...
                  <a class="main-btn" data-scroll-nav="0" href="login/login.php" rel="nofollow">Login</a>
                <?php }else{?>
                  <a href="javascript:void(0)" class="text-white p-2"><?php echo $_SESSION['uid']; ?></a>
                  <a class="main-btn" data-scroll-nav="0" href="login/logout.php" rel="nofollow">Logout</a>
                <?php } ?>
                </div>
              </nav>
              <!-- navbar -->
            ...
            <div class="col-lg-8">
              <div class="header-hero-content text-center">
                ...
                <p
                  ...
                  data-wow-delay="0.8s"
                >
                  Website resmi kelas Teknik Informatika 1B
                </p>
                <a
                  href="halaman/index.php"
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-5 col-sm-12">
              ...
              >
                ...
                <ul class="contact">
                  <li>+6285161787501</li>
                  <li>parzivalxdd@gmail.com</li>
                  <li>
                    Bukit Rata , Lhokseumawe <br />
                    Aceh.
                  </li>
                </ul>
              </div>
              ...
              <div class="copyright d-sm-flex justify-content-between">
                <div class="copyright-content">
                  <p class="text">
                    ...
                    <a href="https://instagram.com/its.przvl._" rel="nofollow">Muhammad Kholis</a>
                  </p>
                </div>
                <!-- copyright content -->
              </div>
